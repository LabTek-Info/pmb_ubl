			...
			<div class="row">
				<div class="col-md-12 input-data-awal">
					...
					<hr>
						...
						<p>1. Hasil Scan STTB SMA/MA/SMK sederajat terlegalisir</p>
						<div class="fileupload fileupload-new" data-provides="fileupload" name="file">						
							<span class="btn btn-primary btn-file" name="file"><span name="file" class="fileupload-new">Pilih File</span>
							<span class="fileupload-exists" name="file">Change</span><input name="file" type="file" /></span>
							<span class="fileupload-preview priview" name="file">Upload File</span>
							<a href="#" class="close fileupload-exists" name="file" data-dismiss="fileupload" style="float: none">×</a>
						</div>
					
						<p>2. Hasil Scan SKHU/DANEM/DANUAS sederajat terlegalisir</p>
						<div class="fileupload fileupload-new" data-provides="fileupload" name="file1">
							<span class="btn btn-primary btn-file" name="file1"><span name="file1" class="fileupload-new">Pilih File</span>
							<span class="fileupload-exists" name="file1">Change</span><input name="file1" type="file" /></span>
							<span class="fileupload-preview priview" name="file1">Upload File</span>
							<a href="#" class="close fileupload-exists" name="file1" data-dismiss="fileupload" style="float: none">×</a>
						</div>

						<p>3. Hasil Scan KTP/Kartu Pelajar dan KTP orang tua</p>
						<div class="fileupload fileupload-new" data-provides="fileupload" name="file2">
							<span class="btn btn-primary btn-file" name="file2"><span name="file2" class="fileupload-new">Pilih File</span>
							<span class="fileupload-exists" name="file2">Change</span><input name="file2" type="file" /></span>
							<span class="fileupload-preview priview" name="file2">Ktp Anda</span>
							<a href="#" class="close fileupload-exists" name="file2" data-dismiss="fileupload" style="float: none">×</a>
						</div>
						<div class="fileupload fileupload-new" data-provides="fileupload" name="ktp">
							<span class="btn btn-primary btn-file" name="ktp"><span name="file2" class="fileupload-new">Pilih File</span>
							<span class="fileupload-exists" name="ktp">Change</span><input name="ktp" type="file" /></span>
							<span class="fileupload-preview priview" name="ktp">Ktp Orang Tua Anda</span>
							<a href="#" class="close fileupload-exists" name="ktp" data-dismiss="fileupload" style="float: none">×</a>
						</div>
						<p>4. Foto berwarna ukuran 3x4 cm dan 4x6 cm</p>
						<div class="fileupload fileupload-new" data-provides="fileupload" name="file3">
							<span class="btn btn-primary btn-file" name="file3"><span name="file3" class="fileupload-new">Pilih File</span>
							<span class="fileupload-exists" name="file3">Change</span><input type="file" name="file3"/></span>
							<span class="fileupload-preview priview" name="file3">Foto 3x4</span>
							<a href="#" class="close fileupload-exists" name="foto" data-dismiss="fileupload" style="float: none">×</a>
						</div>
						<div class="fileupload fileupload-new" data-provides="fileupload" name="foto">
							<span class="btn btn-primary btn-file" name="foto"><span name="foto" class="fileupload-new">Pilih File</span>
							<span class="fileupload-exists" name="foto">Change</span><input type="file" name="foto"/></span>
							<span class="fileupload-preview priview" name="foto">Foto 4x6</span>
							<a href="#" class="close fileupload-exists" name="foto" data-dismiss="fileupload" style="float: none">×</a>
						</div>
					<hr>
					<button type="submit" name="btnsave" class="btn btn-primary send">Kirim File</button>
				</div>				
			</div>
		</form>
		</div>
				...
				<form method="post" class="col-md-12" enctype="multipart/form-data">
					...
					<div class="col-md-4">
						...
						<div class="form-group">
							...
							<input name="nama_pendaftar" value="<?php echo $userRow['userName']; ?>" type="text" class="form-control" id="exampleInputPassword1" placeholder="Type Here...">
						</div>
						<div class="form-group">
							<label for="exampleInputEmail1" class="label-data">Email Calon Mahasiswa</label>						
							<input name="email" type="email" value="<?php echo $userRow['userEmail']; ?>" class="form-control" id="exampleInputEmail1" placeholder="Type Here...">
						</div>
					
						<div class="form-group">
							<label for="exampleInputAlamatl1" class="label-data">Alamat Calon Mahasiswa</label>						
							<input type="text" name="alamatRmh" class="form-control" id="exampleInputAlamat1" placeholder="Type Here...">
						</div>
					
						<div class="form-group">
							<label for="exampleInputKota1" class="label-data">Kota / Kabupaten</label>						
							<input type="text" name="kotaRmh" class="form-control" id="exampleInputKota1" placeholder="Type Here...">
						</div>
			
						 <div class="form-group">
							<label for="exampleSelect1" class="label-data">Provinsi</label>
							<select class="form-control" name="provinsiRmh" id="exampleSelect1">
								<option name="provinsiRmh">-Pilih Provinsi-</option>
					...
					<div class="col-md-4">
						...
						<div class="form-group">
							...
							<input type="text" name="asalSekolah" class="form-control" id="exampleInputSekolah1" placeholder="Type Here...">
						</div>
					
						<div class="form-group">
							<label for="exampleInputKota1" class="label-data">Kota / Kabupaten</label>
							<input type="text" class="form-control" name="kotaSekolah" id="exampleInputKota1" placeholder="Type Here...">
						</div>
							...
							<div class="col-md-4">
								<h1 class="desc">Nama Orang Tua</h1>
									<div class="form-group">
										...
										<input type="text" name="namaAyah" class="form-control" id="exampleInputAyah1" placeholder="Type Here...">
									</div>
									
									<div class="form-group">
										<label for="exampleInputIbu1" class="label-data">Nama Ibu</label>				
										<input name="namaIbu" type="text" class="form-control" id="exampleInputIbu1" placeholder="Type Here...">
									</div>
							</div>
							...
							<div class="col-md-4">
								<h1 class="desc">Kontak Aktif</h1>
									<div class="form-group">
										...
										<input name="noTelpRmh" type="text" class="form-control" id="exampleInputTelp1" placeholder="Type Here...">
									</div>
									<div class="form-group">
										<label for="exampleInputHand1" class="label-data">Nomor Handphone Aktif</label>
										<input name="noHp" type="text" class="form-control" id="exampleInputHand1" placeholder="Type Here...">
									</div>
									<div class="form-group">
										<label for="exampleInputWA1" class="label-data">Nomor WhatsApp Aktif</label>
										<input type="text" name="noHpWA" class="form-control" id="exampleInputWA1" placeholder="Type Here...">
									</div>
									<div class="form-group">
										<label for="exampleInputKeluarga1" class="label-data">Nomor Keluarga Terdekat</label>
										<input type="text" name="noTelpKelTerdekat" class="form-control" id="exampleInputKeluarga1" placeholder="Type Here...">
									</div>
									<div class="form-group">
										<label for="exampleInputBBM1" class="label-data">Pin BBM</label>
										<input type="text" class="form-control" name="pinBbm" id="exampleInputBBM1" placeholder="Type Here...">
									</div>
							</div>
						...
						<div class="col-md-12 bottom">							
							...
							<div class="col-md-4">
								...
								<div class="form-group">
									...
									<input type="text" name="nilBindo" class="form-control" id="exampleInputBindo1" placeholder="Type Here...">
								</div>
								<div class="form-group">
									<label for="exampleInputBingris1" class="label-data">Nilai Bahasa Inggris</label>
									<input type="text" name="nilBing" class="form-control" id="exampleInputBingris1" placeholder="Type Here...">
								</div>
								<div class="form-group">
									<label for="exampleInputMatematika1" class="label-data">Nilai Matematika</label>
									<input type="text" name="nilMtk" class="form-control" id="exampleInputMatematika1" placeholder="Type Here...">
								</div>
							</div>
					...
					<button type="submit" name="btnsimpan" class="btn btn-success">Kirim Data</button>
				</div>				
			</form>
		</div>
		</div>		
